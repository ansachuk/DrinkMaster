...
const LogoutOptions = forwardRef(({ handlerLogoutDropdownClick }, ref) => {
	...
	return (
		<div className={css.logout_container} ref={ref}>
			<button onClick={handlerLogoutDropdownClick} className={css.close_button}>
			...
			<div className={css.button_container}>
				<MainButton onClick={handlerLogoutClick} propClass={buttonCss.biggerButton} title="Logout" />
				<MainButton onClick={handlerLogoutDropdownClick} propClass={buttonCss.cancelButton} title="Cancel" />
			</div>
		</div>
	);
});
