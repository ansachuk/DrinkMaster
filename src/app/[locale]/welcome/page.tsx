...
const styles =
	"py-4 px-10 rounded-[42px] border-[1px] border-gray-100/20 bg-gray-100 text-main-black hover:bg-transparent hover:text-white transition-colors duration-300";
